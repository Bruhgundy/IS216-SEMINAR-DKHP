...
import com.reg.exceptions.*;
import com.reg.models.*;
import com.reg.repos.*;
...
public class RegistrationService {
    ...
    public void cancel(Long registrationId) {
        ...
        courseRepository.incrementSeat(reg.getCourse().getId());
        registrationRepository.updateStatus(registrationId, Registration.RegistrationStatus.CANCELLED);
    }
    ...
    private void guardScheduleConflict(Student student, Course newCourse) {
        List<Registration> existing = registrationRepository
                .findActiveByStudentAndDay(student.getId(), newCourse.getDayOfWeek());
